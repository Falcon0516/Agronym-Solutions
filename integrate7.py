...
# Sensor data
current_soil_moisture = "N/A"  # Changed to text value
...
def setupGPIO():
    ...
    # Soil moisture sensor setup (as input)
...
def read_soil_moisture():
    try:
        ...
        moisture_value = GPIO.input(SOIL_MOISTURE_PIN)
        # Return text description based on value
        return "Wet" if moisture_value == 0 else "Dry"
    ...
    def do_GET(self):
        ...
        if self.path == '/status':
            ...
            status_data = {
                ...
                "soil_moisture": current_soil_moisture  # Now returns text value
            }
        ...
        <head>
            ...
            <title>Farm Control Panel</title>
            <style>
                body {
                        ...
                        <div class="sensor-readings">
                            <div class="sensor-reading">
                                ...
                                <div class="sensor-value">
                                    <span id="soil_moisture" class="moisture-''' + current_soil_moisture.lower() + '''">''' + current_soil_moisture + '''</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                setInterval(function() {
                    fetch('/status')
                        ...
                        .then(data => {
                            ...
                            const moistureElement = document.getElementById('soil_moisture');
                            moistureElement.textContent = data.soil_moisture;
                            // Update class based on moisture value
                            moistureElement.className = 'moisture-' + data.soil_moisture.toLowerCase();
