...
host_port = 8080  # Changed to 8080 as suggested alternative
...
# PWM objects made global to ensure they're accessible everywhere
left_pwm = None
right_pwm = None
...
def move_forward(speed_percent):
    ...
    print("Moving forward at speed:", speed_percent)
...
def move_reverse(speed_percent):
    ...
    print("Moving reverse at speed:", speed_percent)
    ...
    def do_POST(self):
        ...
        try:
            ...
            # Handle speed change
                ...
                if rover_status == "RUNNING" and left_pwm is not None and right_pwm is not None:
                    left_pwm.ChangeDutyCycle(current_speed)
                    right_pwm.ChangeDutyCycle(current_speed)
...
# Clean up function
def cleanup():
    global is_running, left_pwm, right_pwm
