...
import threading
import Adafruit_DHT  # Correct import for DHT sensor

# Server configuration
host_name = '0.0.0.0'  # Listen on all network interfaces
host_port = 5000  # Changed to port 5000 as requested

# Motor driver pins (L298N) - Rover
# Left motor
in1_left = 17
in2_left = 27
# Right motor
...
# Sensor pins (using different pins than existing ones)
DHT_PIN = 4  # GPIO4 (pin 7)
SOIL_MOISTURE_PIN = 18  # GPIO18 (pin 12)
...
valve_status = "STOPPED"  # Current valve status
valve_pwm = None  # PWM object for valve control
...
# Function to read soil moisture (digital sensor)
def read_soil_moisture():
    try:
        # Read digital input from soil moisture sensor
        # Note: This will return 0 (wet) or 1 (dry) for most basic sensors
        # We'll invert it to show moisture percentage (0% = dry, 100% = wet)
        moisture = not GPIO.input(SOIL_MOISTURE_PIN)  # Invert because pull-up is used
        return moisture * 100  # Convert to percentage
    except Exception as e:
...
class ControlServer(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        global rover_status, current_speed, movement_direction, distance_traveled, total_distance, current_side, valve_status
        global current_temperature, current_humidity, current_soil_moisture
        ...
        if self.path == '/status':
            ...
            status_data = {
                ...
                "env_temperature": round(current_temperature, 1) if current_temperature is not None else "N/A",
                "humidity": round(current_humidity, 1) if current_humidity is not None else "N/A",
                "soil_moisture": round(current_soil_moisture, 1) if current_soil_moisture is not None else "N/A"
            }
        ...
        <head>
            ...
            <title>Raspberry Pi Control System</title>
            <style>
                body {
        ...
        <body>
            <div class="container">
                <header>
                    <h1>Raspberry Pi Control System</h1>
                </header>
                ...
                <div class="info-panel">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-value">
                            <span id="rover_status">''' + rover_status + '''</span>
                        </div>
                    </div>
                    ...
                    <div class="info-box">
                        <h3>Valve Status</h3>
                        <div class="info-value">
                            <span id="valve_status">''' + valve_status + '''</span>
                        </div>
                    </div>
                ...
                <div class="control-panel">
                    ...
                    <div class="control-section">
                        ...
                        <div class="button-group">
                            <button onclick="sendCommand('OPEN_VALVE')" class="open">Open Valve</button>
                            <button onclick="sendCommand('CLOSE_VALVE')" class="close">Close Valve</button>
                            <button onclick="sendCommand('STOP_VALVE')" class="stop">Stop Valve</button>
                        </div>
                        
                        <div class="sensor-readings">
                            <div class="sensor-reading">
                                <h3>Environment Temperature</h3>
                                <div class="sensor-value"><span id="env_temp">0.0</span> °C</div>
                            </div>
                            <div class="sensor-reading">
                                <h3>Humidity</h3>
                                <div class="sensor-value"><span id="humidity">0.0</span> %</div>
                            </div>
                            <div class="sensor-reading">
                                <h3>Soil Moisture</h3>
                                <div class="sensor-value"><span id="soil_moisture">0.0</span> %</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <footer>
                    <p>Raspberry Pi Control System</p>
                </footer>
            </div>
                ...
                setInterval(function() {
                    fetch('/status')
                        ...
                        .then(data => {
                            ...
                            document.getElementById('rover_status').textContent = data.rover_status;
                            document.getElementById('direction').textContent = data.direction;
                            document.getElementById('valve_status').textContent = data.valve_status;
                            ...
                            document.getElementById('env_temp').textContent = data.env_temperature;
    ...
    def do_POST(self):
        ...
        global distance_traveled, current_side, valve_status
        ...
        try:
            ...
            if 'command=' in post_data:
                ...
                if command == 'START':
                    ...
                    if not hasattr(GPIO, "_initialized") or not GPIO._initialized:
                        setupGPIO()
                ...
                # Valve commands
                elif command == 'OPEN_VALVE':
                    print("Opening valve")
                    open_valve()
                
                elif command == 'CLOSE_VALVE':
                    print("Closing valve")
                    close_valve()
                
                elif command == 'STOP_VALVE':
                    print("Stopping valve")
                    stop_valve()
...
# Clean up function
def cleanup():
    global is_running, valve_pwm, sensor_thread
    ...
    if sensor_thread is not None:
        sensor_thread.join(2)  # Wait up to 2 seconds for thread to finish
...
if __name__ == '__main__':
    try:
        ...
        http_server = HTTPServer(server_address, ControlServer)
