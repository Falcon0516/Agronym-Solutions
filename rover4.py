...
# Left motor
in1_left = 17  # Previously 3
in2_left = 22  # Previously 5

# Right motor
in3_right = 23  # Previously 11
in4_right = 24  # Previously 13
...
# Motor control functions (updated to match working code)
def move_forward():
    global rover_status
    ...
    def do_POST(self):
        ...
        try:
            ...
            # Handle speed change
                ...
                # Since we're not using PWM, speed is just tracked for display purposes
